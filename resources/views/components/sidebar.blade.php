        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/home" class="app-brand-link" style="text-decoration:none">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2" >AIMS</span>
            </a>
...
<!-- admin lonin -->
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- attendance -->
            <li class="menu-item">
              <a href="/attendance" class="menu-link" style="text-decoration:none">
             ...
             <!-- student -->
            <li class="menu-item">
              <a href="/student" class="menu-link" style="text-decoration:none">
            ...
            <!-- teacher -->
            <li class="menu-item">
              <a href="/teacher" class="menu-link" style="text-decoration:none">
                <i class="menu-icon tf-icons bx bx-user"></i>
            ...
            <!-- payment -->
            <li class="menu-item">
              <a href="/parent" class="menu-link" style="text-decoration:none">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div data-i18n="Basic">Parent</div>
              </a>
            </li>
            <!-- courses -->
            <li class="menu-item">
              <a href="/subject" class="menu-link" style="text-decoration:none">
            ...
            <!-- exams -->
            <li class="menu-item">
              <a href="/class" class="menu-link" style="text-decoration:none">
             ...
             <!-- account -->
            <li class="menu-item">
              <a href="/useraccount" class="menu-link" style="text-decoration:none">
                <i class='menu-icon bx bx-user-check'></i>
                <div data-i18n="Basic"> Assign Role</div>
              </a>
            </li>
            <!-- settings -->
            <li class="menu-item" >
              <a href="/roleparmision" class="menu-link" style="text-decoration:none">
